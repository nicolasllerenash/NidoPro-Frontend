          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li className="flex items-start space-x-2">
                ...
                <span>Asegúrate de tener períodos escolares creados antes de generar bimestres o pensiones.</span>
              </li>
              <li className="flex items-start space-x-2">
                <span className="text-blue-500 mt-1">•</span>
                <span>Las pensiones solo se generarán para estudiantes con matrícula activa en el período seleccionado.</span>
              </li>
              <li className="flex items-start space-x-2">
                <span className="text-blue-500 mt-1">•</span>
